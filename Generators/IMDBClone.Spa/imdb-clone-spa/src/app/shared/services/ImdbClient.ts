...
export class ImdbClient {
     ...
     * @return Success
     */
    createMovie(body?: MovieForm | undefined): Observable<MovieDtoLite> {
        let url_ = this.baseUrl + "/api/movies";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<MovieDtoLite>;
                }
            } else
                return _observableThrow(response_) as any as Observable<MovieDtoLite>;
        }));
    }

    protected processCreateMovie(response: HttpResponseBase): Observable<MovieDtoLite> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MovieDtoLite.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<MovieDtoLite>(null as any);
    }
...
export class MovieDtoLite implements IMovieDtoLite {
    id?: string | undefined;
    name?: string | undefined;
    description?: string | undefined;
    tags?: string[] | undefined;
    ...
    constructor(data?: IMovieDtoLite) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MovieDtoLite {
        data = typeof data === 'object' ? data : {};
        let result = new MovieDtoLite();
        result.init(data);
        return result;
    }
...
export interface IMovieDtoLite {
    id?: string | undefined;
    name?: string | undefined;
    description?: string | undefined;
    tags?: string[] | undefined;
